%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% This is the key file for exercise 4.1 %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Alternatively, you can also use a while loop:
%  i = 1;
%  while Fx(i) < target
%      i = i + 1;
%  end
...
% PCP
fprintf(['The order quantity is the same as we had before, hence, the PCP\n' ...
         'is zeros, because exactly the same decision is made.\n\n']);
