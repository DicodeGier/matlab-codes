...
z_star_obj = [results{:,4}];

obj = [z_obj y_1_obj y_2_obj binary_obj z_star_obj];

%%%not necessary for mean path
...
constraint_matrix = [mean_first_constraint_matrix; mean_second_constraint_matrix; mean_third_constraint_matrix; mean_fourth_constraint_matrix; second_constraint_matrix; third_constraint_matrix; fourth_constraint_matrix; binary_constraint_matrix; fifth_constraint_matrix];
sparse_constraint_matrix = sparse(constraint_matrix);
rhs_till_now = [rhs_mean_first_constraint; rhs_mean_second_constraint; rhs_mean_third_constraint; rhs_mean_fourth_constraint; rhs_second_constraint; rhs_third_constraint; rhs_fourth_constraint; rhs_binary_constraint];
