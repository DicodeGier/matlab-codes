 function [optimal_value,used_budget,new_budget,upgrade_matrix_shsr,upgrade_matrix_hsr,cost_upgrade_matrix_shsr,cost_upgrade_matrix_hsr] = one_shortest_path_mean_path(budget,alpha,nodes,rhs_till_now,obj,sparse_constraint_matrix,number_edges,cost_shsr,cost_hsr)
    %%%output:
    ...
    model.rhs = rhs;
    model.sense = ['='; repmat('<',number_edges,1); repmat('<',number_edges,1); repmat('<', number_edges,1); '<'];
    ...
    cost_model.sense = ['='; repmat('<',number_edges,1); repmat('<',number_edges,1); repmat('<', number_edges,1); '<';'<'];
